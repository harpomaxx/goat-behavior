...
source("code/R/functions/plot_shap.R")
p<-shap_summary_plot(shap_values )
p
plotly::ggplotly(p)
...
p1 <- contribution_plot(shap_values_G,num_row = 1) + labs(title="Anim a13: class G (FN)", subtitle = "SHAP analysis for class G") 
p2 <- contribution_plot(shap_values_GM,num_row = 1) + labs(title="Anim a13: class G (FN)",subtitle = "SHAP analysis for class GM") 

p3 <- contribution_plot(shap_values_G,num_row = 5) + labs(title="Anim a13: class G (TP)", subtitle = "SHAP analysis for class G") 
p4 <- contribution_plot(shap_values_GM,num_row = 5) + labs(title="Anim a13: class G (TP)",subtitle = "SHAP analysis for class GM") 
...
shap_values_G <- calculate_shap_class(new_dataset, new_data = new_dataset_filtered, goat_model, nsim = 100, p_function_G,"G")
shap_values_GM <- calculate_shap_class(new_dataset, new_data = new_dataset_filtered, goat_model, nsim = 100, p_function_GM,"GM")
p1 <- contribution_plot(shap_values_GM,num_row = 8) + labs(title="Anim a13: class GM (FN)", subtitle = "SHAP analysis for class GM") 
p2 <- contribution_plot(shap_values_G,num_row = 8) + labs(title="Anim a13: class GM, (FN)",subtitle = "SHAP analysis for class G") 

p3 <- contribution_plot(shap_values_GM,num_row = 2) + labs(title="Anim a13: class GM (TP)", subtitle = "SHAP analysis for class GM") 
p4 <- contribution_plot(shap_values_G,num_row = 2) + labs(title="Anim a13: class GM (TP)",subtitle = "SHAP analysis for class G") 
...
shap_values_G <- calculate_shap_class(new_dataset, new_data = new_dataset_filtered, goat_model, nsim = 100, p_function_G,"G")
shap_values_GM <- calculate_shap_class(new_dataset, new_data = new_dataset_filtered, goat_model, nsim = 100, p_function_GM,"GM")
p1 <- contribution_plot(shap_values_G,num_row = 3) + labs(title="Anim a5: class G (FN)", subtitle = "SHAP analysis for class G") 
p2 <- contribution_plot(shap_values_GM,num_row = 3) + labs(title="Anim a5: class G (FN)",subtitle = "SHAP analysis for class GM") 

p3 <- contribution_plot(shap_values_G,num_row = 1) + labs(title="Anim a5: class G (TP)", subtitle = "SHAP analysis for class G") 
p4 <- contribution_plot(shap_values_GM,num_row = 1) + labs(title="Anim a5: class G (TP)",subtitle = "SHAP analysis for class GM") 
...
shap_values_G <- calculate_shap_class(new_dataset, new_data = new_dataset_filtered, goat_model, nsim = 100, p_function_G,"G")
shap_values_GM <- calculate_shap_class(new_dataset, new_data = new_dataset_filtered, goat_model, nsim = 100, p_function_GM,"GM")
p1 <- contribution_plot(shap_values_GM,num_row = 4) + labs(title="Anim a5: class GM (FN)", subtitle = "SHAP analysis for class GM") 
p2 <- contribution_plot(shap_values_G,num_row = 4) + labs(title="Anim a5: class GM (FN)",subtitle = "SHAP analysis for class G") 

p3 <- contribution_plot(shap_values_GM,num_row = 3) + labs(title="Anim a5: class GM (TP)", subtitle = "SHAP analysis for class GM") 
p4 <- contribution_plot(shap_values_G,num_row = 3) + labs(title="Anim a5: class GM (TP)",subtitle = "SHAP analysis for class G") 
...
p1 <- contribution_plot(shap_values_G,num_row = 1) + labs(title="Anim a16: class G (FN)", subtitle = "SHAP analysis for class G") 
p2 <- contribution_plot(shap_values_GM,num_row = 1) + labs(title="Anim a16: class G (FN)",subtitle = "SHAP analysis for class GM") 

p3 <- contribution_plot(shap_values_G,num_row = 6) + labs(title="Anim a16: class G (TP)", subtitle = "SHAP analysis for class G") 
p4 <- contribution_plot(shap_values_GM,num_row = 6) + labs(title="Anim a16: class G (TP)",subtitle = "SHAP analysis for class GM") 
