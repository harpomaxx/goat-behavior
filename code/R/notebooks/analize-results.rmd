...
shap_values_G <- calculate_shap_class(new_dataset, new_data = new_dataset_filtered, goat_model, nsim = 100, p_function_G,"G")
shap_values_GM <- calculate_shap_class(new_dataset, new_data = new_dataset_filtered, goat_model, nsim = 100, p_function_GM,"GM")
p1 <- contribution_plot_w_feature(shap_values_G,new_dataset_scaled_filtered,num_row = 3) + labs(title="Anim a5: class G (FN)", subtitle = "SHAP analysis for class G") 
p2 <- contribution_plot_w_feature(shap_values_GM,new_dataset_scaled_filtered,num_row = 3) + labs(title="Anim a5: class G (FN)",subtitle = "SHAP analysis for class GM") 

p3 <- contribution_plot_w_feature(shap_values_G,new_dataset_scaled_filtered,num_row = 1) + labs(title="Anim a5: class G (TP)", subtitle = "SHAP analysis for class G") 
p4 <- contribution_plot_w_feature(shap_values_GM,new_dataset_scaled_filtered,num_row = 1) + labs(title="Anim a5: class G (TP)",subtitle = "SHAP analysis for class GM") 
...
shap_values_G <- calculate_shap_class(new_dataset, new_data = new_dataset_filtered, goat_model, nsim = 100, p_function_G,"G")
shap_values_GM <- calculate_shap_class(new_dataset, new_data = new_dataset_filtered, goat_model, nsim = 100, p_function_GM,"GM")
p1 <- contribution_plot_w_feature(shap_values_GM,new_dataset_scaled_filtered,num_row = 4) + labs(title="Anim a5: class GM (FN)", subtitle = "SHAP analysis for class GM") 
p2 <- contribution_plot_w_feature(shap_values_G,new_dataset_scaled_filtered,num_row = 4) + labs(title="Anim a5: class GM (FN)",subtitle = "SHAP analysis for class G") 

p3 <- contribution_plot_w_feature(shap_values_GM,new_dataset_scaled_filtered,num_row = 3) + labs(title="Anim a5: class GM (TP)", subtitle = "SHAP analysis for class GM") 
p4 <- contribution_plot_w_feature(shap_values_G,new_dataset_scaled_filtered,num_row = 3) + labs(title="Anim a5: class GM (TP)",subtitle = "SHAP analysis for class G") 
