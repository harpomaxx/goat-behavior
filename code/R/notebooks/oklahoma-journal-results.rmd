...
data_caprino_ok_numeric_w_classes<- train_dataset_boruta %>% filter(!(Anim %in% c(1553,1635,505081,505075) ))
train_dataset_boruta<- train_dataset_boruta %>% filter(Anim %in% c(1553,1635,505081,505075) )  %>% select(-Anim)
...
We use ~25% of the dataset for selecting features using BORUTA algorithm. 
Four animals were removed.

```{r}
num_of_feat<-10
var_importance_boruta<-Boruta(Activity ~ . ,data=train_dataset_boruta %>% na.omit())
